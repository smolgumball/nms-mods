...
GameVersion = "3.89"
ModVersion = "a"
ModNameSub = "Standing 1"
BaseDescription = "Makes Standing Light 1 work without power and improves lighting."
...
FileSource1 = "MODELS\PLANETS\BIOMES\COMMON\BUILDINGS\PARTS\BUILDABLEPARTS\DECORATION\STANDINGLIGHT1.SCENE.MBIN"
		...
		["MBIN_CHANGE_TABLE"] = {
			{
				...
				["EXML_CHANGE_TABLE"] = {
					...
					{ ["SPECIAL_KEY_WORDS"] = { "Name", "StandingLight_1" },
						["LINE_OFFSET"] = "-4",
						["ADD"] = EntityText,
					},
