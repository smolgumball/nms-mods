...
BonusSameTypeAdd    = 0.1 --0.06 ;
BonusSameTypeMult   = 0.15 --0.04 ;
BonusChildAdd       = 0.05 --0.05 ;
BonusChildMult      = 0.075 --0.03 ;
...
ShipScanPulseRange       = 15000 --10000; Ship scan range, in u
ShipScanRecharge         = 1 --Ship scan recharge time, in seconds. Original value "10"
SurveyMaxDistance        = 750 --How far away the scanner can detect hotspots, in u. Maximum is about 1300, but over 1000 is unreliable. Original value "400"
SurveySonarMinPulseSpeed = -1.0 --0.4 ; Frequency for sweeps or pings of the hotspot scanner. Lower is slower
...
--Misc Adjustments
RefinerProductsMadeInTime         = 40 --2 ;
...
ShipInteractRadius                = 400 --80 ; How close you need to be to your ship to interact with it, in u
...
DeadPlanetGravityFactor           = 0.6 --0.6
