...
GameVersion = "3.89"
ModVersion = "a"
ModNameSub = "Standing 3"
BaseDescription = "Makes Standing Light 3 work without power and improves lighting."
...
FileSource1 = "MODELS\PLANETS\BIOMES\COMMON\BUILDINGS\PARTS\BUILDABLEPARTS\DECORATION\STANDINGLIGHT3.SCENE.MBIN"
		...
		["MBIN_CHANGE_TABLE"] = {
			{
				...
				["EXML_CHANGE_TABLE"] = {
					...
					{ ["SPECIAL_KEY_WORDS"] = { "Name", "_Light_B" },
						["LINE_OFFSET"] = "-4",
						["ADD"] = EntityText,
					},
